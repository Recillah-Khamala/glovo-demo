...
const GlovoTextLogo = () => (
  <svg
    ...
    viewBox="0 0 95 32"
    className="hidden md:block h-8 md:h-10 w-[100px] md:w-[120px]"
...
const Header = () => {
  ...
  return (
    <header
      className="bg-[#FFC244FF] fixed w-full z-50"
      // Yellow background, subtle shadow, fixed to top, full width, high z-index for overlay
    >
      <div className="mx-auto flex justify-between items-center box-border w-full max-w-[calc(1124px+15%)] py-2 md:py-4 px-4 md:px-[7.5%]">
        {/* Container with responsive padding, flex layout, and centered items */}
...
export default Header; // Makes the Header component available for import
